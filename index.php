...
<head>
    <meta charset="UTF-8">
    <link rel="icon" type="image/vnd.microsoft.icon" href="Img/fraternidadlogo2.png" sizes="16x16 32x32">
    <meta name="description" content="Dental Rojas tu centro de dentista de confianza">
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>JOSE MANUEL RODRIGUEZ | Inicio </title>
    <!-- CSS -->
    <link rel="stylesheet" href="Css/correcion.css">
    <link rel="stylesheet" href="Css/estilos.css">
    <link rel="stylesheet" href="Css/botones.css">
    <link rel="stylesheet" href="Css/CardPro.css">
    <link rel="stylesheet" href="Css/hamburguesa.css">
    <link rel="stylesheet" href="Css/navbarScroll.css">
...
<body>
        ...
        <div class="popup-whatsapp fadeIn">
            <div class="content-whatsapp -top"><button type="button" class="closePopup">
                ...
                <div class="container ">
                    <div class="row">
                        <div class="col-md-2">
                            <center><img src="Img/Persona.png" width="50" alt="persona"></center>
                        </div>
            ...
            <div class="content-whatsapp -bottom">
                ...
                <button class="send-msPopup" id="send-btn" type="button">
                      <i class="fa fa-send" style="margin-left: -4px;"></i>
                  </button>
            </div>
        </div>
    ...
    <!--FIN DE BOTON WSP-->
    <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0" class="scrollspy-example" tabindex="0" id="Titulo">
        <!-- Banner Image  -->
        <div class="banner-image2 w-100 vh-100 d-flex justify-content-center align-items-center">
            <div class="row" style="width: 99%;">
                <center>
                    <div class="content text-center" data-aos="zoom-in" data-aos-duration="1200">
                        <h1 class="text-white sombraL" style="font-size: 6rem; text-shadow: black 0.1em 0.1em 0.2em;">Fraternindad Católica</h1>
                        <h2 class="text-white sombraL" style="font-size: 1.9rem; text-shadow: #936d04 0.1em 0.1em 0.2em;">Encuentro de Hermanos con Jesucristo</h2>
                        <h2 class="text-white sombraL" style="font-size: 1.9rem; text-shadow: #936d04 0.1em 0.1em 0.2em;">En el camino, la verdad y la vida</h2>
                    </div>
                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                        <a href="#Articulos" id="btnConsultar" class="btn btn-lg btn-outline-primary sombraB " style="background-color: #00b7ff; color:white; border-color: #c59613;" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300" >Consultar Contenido</a>
                        <!--<a href="vistas/Turnos/turnos.html" class="btn btn-lg btn-outline-primary sombraB2 " style="background-color: #00b7ff; color:white;" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="300">Realizar un Turno</a>-->
                    </div>
                </center>
            </div>
        </div>
    ...
    <div class="container" style="background-color: rgb(255, 255, 255); width: 100%, 100%;">
        ...
        <div class="container">
            ...
            <div class="row">
                <!--Inicio-->
                <div class="col-md-6" data-aos="zoom-in" data-aos-duration="900" style="margin-top: 40px;">
                    <center>
                ...
                <div class="col-md-6" style="margin: auto auto;">
                    <img src="Img/fraternidadlogo.jpg" class="d-block w-100" alt="img1" style="margin-left: 27%; width: 60% !important;">
                </div>
            </div>
    ...
    <path fill="rgb(255, 255, 255)" fill-opacity="1" d="M0,256L80,218.7C160,181,320,107,480,112C640,117,800,203,960,224C1120,245,1280,203,1360,181.3L1440,160L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z" ></path>
        ...
        <div class="container p-4 pb-0">
            ...
            <section>
                ...
                <div class="row">
                    <!-- LOGO column -->
                    <div class="col-md-3 col-lg-3 col-xl-3 col-xxl-3 mx-auto mb-5 imagenLogoFooter">
                        <img src="panel/img/logo/fmslogan.png" style="width: 275px;" alt="logo">
                    </div>
                    ...
                    <div class="col-md-4 col-lg-2 col-xl-2 col-xxl-2">
                        <h1 class="text-uppercase mb-4 font-weight-bold" id="size_persona">Artículos de:</h1>
                        <p>
                            <a class="text-white">Teología</a>
                        </p>
                        <p>
                            <a class="text-white">Filosofía</a>
                        </p>
                        <p>
                            <a class="text-white">Historia</a>
                        </p>
                        <p>
                            <a class="text-white">Y más</a>
                        </p>
                    </div>
                    <!-- LINEA -->
                    <hr class="w-100 clearfix d-md-none" />
                    ...
                    <!-- CONTACTOS column -->
                    <div class="col-md-3">
                        <h1 class="text-uppercase mb-4 font-weight-bold" id="size_persona">Contacto</h1>
                        <p><i class="bi bi-building"></i> Tapachula, Chiapas</p>
                        <p><i class="bi bi-envelope-open"></i> fraternidadmundial@gmail.com</p>
                        <p><i class="bi bi-telephone-outbound"></i> 4901-5451</p>
                        <p><i class="bi bi-telephone-outbound"></i> +54 9 11 6587-9270</p>
                    </div>
                    ...
                    <div class="centered">
                            ...
                            <div class="col-lg ">
                                <!-- Facebook -->
                                <a class="btn btn-primary btn-floating m-1" style="background-color: #3b5998 ; border-radius: 50%;" href="https://www.threads.net/@fraternidadcatolica" target="_blank" role="button"><i class="bi bi-facebook"></i></a>
                                <!-- Instagram -->
                                <a class="btn btn-primary btn-floating m-1" style="background-color: #b83fb8; border-radius: 50%;" href="https://www.threads.net/@fraternidadcatolica" target="_blank" role="button"><i class="bi bi-instagram"></i></a>
                                <!-- Wsp -->
                                <a class="btn btn-primary btn-floating m-1" style="background-color: #2fca00  ; border-radius: 50%;" href="https://www.threads.net/@fraternidadcatolica" target="_blank" role="button"><i class="bi bi-whatsapp"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
